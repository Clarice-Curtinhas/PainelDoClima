...
Adafruit_NeoPixel strip10 = Adafruit_NeoPixel(NUM_PIXELS_QUALI, PIN10, NEO_GRB + NEO_KHZ800); // Cria um objeto da biblioteca NeoPixel
...
Adafruit_NeoPixel strip12 = Adafruit_NeoPixel(NUM_PIXELS_TEMP, PIN12, NEO_GRB + NEO_KHZ800); // Cria um objeto da biblioteca NeoPixel
